...
const FAQ = [
  ...
  { question: 'Можно ли заказать нестандартный размер?', answer: 'Нет. Доступны только размеры, представленные в конфигураторе.' },
  {
    ...
    <Container className="py-10">
      ...
      <section className="mt-14 grid grid-cols-1 gap-6 border-t border-line pt-8 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-steel">
            Самовывоз со складов в Алматы, Астане, Караганде и Шымкенте. Доставка по Алматы, Астане, Караганде и
            Шымкенту — бесплатно, в тот же день. Доставка в другие города и регионы Казахстана — 2–3 дня.
